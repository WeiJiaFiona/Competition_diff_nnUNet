...
def get_loader(args):
    ...
    if args.phase == 'train':
        ...
        for item in args.dataset_list:
            for line in open(os.path.join(args.data_txt_path,  item, 'real_tumor_train_{}.txt'.format(args.fold))):
                # print(os.path.join(args.data_txt_path,  item, 'real_tumor_train_{}.txt'.format(args.fold)))
    ...
    if args.phase == 'validation':
        ...
        val_loader = DataLoader(val_dataset, batch_size=1, shuffle=False, collate_fn=list_data_collate)
